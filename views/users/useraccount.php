...
<div class="users-form">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src=<?= Yii::$app->request->baseUrl.$usersInfo->profile_pic ?> alt="User profile picture">

              <h3 class="profile-username text-center"><?= BaseModel::getUserFullName($usersInfo->id) ?></h3>
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <b>Username</b> <a class="pull-right"><?= $usersInfo->username ?></a>
                </li>
                <li class="list-group-item">
                  <b>Email</b> <a class="pull-right"><?= $usersInfo->email ?></a>
                </li>
                <li class="list-group-item">
                  <b>Status</b><?php
            ...
            <div class="box box-default">
                ...
                <div class="box-body" style="display: block;">
                    <?php $form = ActiveForm::begin([
                        'action' => Yii::$app->request->baseUrl . '/users/updateuserinfo?user_id=' . $modelInfo->user_id . '&module=userinformation' ,
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group div-update-no-load-info text-right">
                                    <?= Html::submitButton('Update', ['class' => 'btn btn-primary btnInfo btn-flat', 'data-placement'=>'right', 'data-toggle'=>'tooltip', 'title'=>'Update Employee Information', 'disabled' => 'disabled']); ?>
                                </div>
                                <div class="form-group div-update-load-info text-right" hidden>
                                    <button class="btn btn-flat btn-default" disabled="disabled"><img src="<?php echo Yii::$app->request->baseUrl ?>/img/loading.gif"/>&nbsp;&nbsp; Updating Employee Information...</button>
                                </div>
                            </div>
                        </div>
                ...
                <!-- <div class="box-footer" style="display: block;">
                    ...
                    <div class="box box-default">
                        ...
                        $form = ActiveForm::begin([
                            'action' => Yii::$app->request->baseUrl . '/users/updateaccount?id=' . $model->id  . '&module=userinformation' ,
                            'enableClientValidation' => false,
                            'options' => [
                                'enctype' => 'multipart/form-data',
                            ],
                    ...
                    <div class="box box-default collapsed-box">
                        ...
                        <div class="box-body" style="display: none;">
                            <?php $form = ActiveForm::begin([
                                'action' => Yii::$app->request->baseUrl . '/users/updateuser?id=' . $model->id  . '&module=userinformation' ,
                                'enableClientValidation' => false,
                                'options' => [
                                    'enctype' => 'multipart/form-data',
                                ],
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group div-update-no-load-email text-right">
                                            <?= Html::submitButton('Update', ['class' => 'btn btn-primary btnEmail btn-flat', 'data-placement'=>'right', 'data-toggle'=>'tooltip', 'title'=>'Update Employee Information', 'disabled' => 'disabled']); ?>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" align="center">
                                    <img src=<?= Yii::$app->request->baseUrl.$usersInfo->profile_pic ?> class="profile-user-img img-responsive img-circle" alt="User Image" style="heigh:150px;width:150px;">
                                </div>
                            </div>
                            <div class="row">
                                <br>
                                <div class="col-md-12" align="center">
                                    <?= BaseModel::getUserFullName($usersInfo->id) ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <?php $form = ActiveForm::begin([
                                            ...
                                            'action' => Yii::$app->request->baseUrl . '/users/updateprofilepicture?id=' . $model->id  . '&module=userinformation' ,
                                        ]);
                                    ?> 
    ...
    <input value='<?= $usersInfo->id ?>' class='178163236' hidden='hidden'/>
</div>
