...
/* @var $searchModel app\models\AccountTitleSearch */
...
<div class="accounttitle-index">
    <section class="content">
      <div class="row">
        <div class="col-md-4">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Account Title</h3>
            </div>
            <div class="box-body">
                <?= $this->render('_form', [
                    'model' => $model,
        ...
        <div class="col-md-8">
            <div class="box box-primary">
              <div class="box-header">
                <h3 class="box-title">Account Title Information</h3>
              </div>
              <div class="box-body">
                <?php
                  $gridcolumns = [
                        ...
                        [
                            ...
                            'filter'=>ArrayHelper::map(AccountTitle::find()->asArray()->all(), 'name', 'name'), 
                            'filterWidgetOptions'=>[
                                'pluginOptions'=>[
                                    'allowClear'=>true,
                                ],
                            ...
                            'filterInputOptions'=>['placeholder'=>'Select Account Title Name'],
                        ...
                        [
                            ...
                            'filterType'=>GridView::FILTER_SELECT2,
                            'filter'=>ArrayHelper::map(AccountTitle::find()->asArray()->all(), 'description', 'description'), 
                            'filterWidgetOptions'=>[
                                'pluginOptions'=>[
                                    'allowClear'=>true,
                                ],
                            ...
                            'filterInputOptions'=>['placeholder'=>'Select Account Title Description'],
                            'value'=>function($model){
                  ...
                  if(Yii::$app->user->can('_DELETE-MULTIPLE-ACCOUNT-TITLE')){
                    $gridcolumns[] = [
                      ...
                      'visible' => (Yii::$app->user->can('_DELETE-MULTIPLE-ACCOUNT-TITLE')),
                      'width' => '50px;'
                    ]; 
                  }

                  $headercols = [
                      ['content' => 'Account Title Information', 'options' => ['colspan' => 100, 'class' => 'text-center bg-primary']],
                  ];

                  $heading = 'List of Account Title';
                  ...
                  $export = ExportMenu::widget([
                      ...
                      'filename' => 'accounttitle',
                  ]);

                  if(Yii::$app->user->can('_DELETE-MULTIPLE-ACCOUNT-TITLE')){
                    $after = '<div class="pull-right">
                    <button type="button" class="btn btn-flat btn-danger deleteSelectedAccountTitlebutton" data-placement="left" data-toggle="tooltip", title="Delete Selected">Delete Selected</button></div><div style="padding-top: 5px;">
                    <em>&nbsp;</em>
                    </div>
...
$('body').on('click', '.deleteSelectedAccountTitlebutton', function(){
    var deleteSelected = $('#accounttitle').yiiGridView('getSelectedRows');
    if (deleteSelected == ''){
        ...
        swal({
          title: 'Are you sure?',
          text: 'The selected account title will be deleted.',
          type: 'warning',
        ...
        function(){
            $.ajax({
                ...
                success : function() {
                    ...
                    swal('Success!', 'Selected Account Title Successfully Deleted.', 'success');
                },
                error: function () {
                    swal('Error', 'Selected Account Title Not Deleted.', 'error');
                }
            });
        });
    }
