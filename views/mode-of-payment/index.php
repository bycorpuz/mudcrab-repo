        ...
        <div class="col-md-8">
            <div class="box box-primary">
              <div class="box-header">
                <h3 class="box-title">Mode of Payment Information</h3>
              </div>
              <div class="box-body">
                <?php
                  $gridcolumns = [
                        ...
                        [
                            ...
                            'filter'=>ArrayHelper::map(ModeOfPayment::find()->asArray()->all(), 'name', 'name'), 
                            'filterWidgetOptions'=>[
                                'pluginOptions'=>[
                                    'allowClear'=>true,
                                ],
                            ...
                            'filterInputOptions'=>['placeholder'=>'Select Mode of Payment Name'],
                        ...
                        [
                            ...
                            'filterType'=>GridView::FILTER_SELECT2,
                            'filter'=>ArrayHelper::map(ModeOfPayment::find()->asArray()->all(), 'description', 'description'), 
                            'filterWidgetOptions'=>[
                                'pluginOptions'=>[
                                    'allowClear'=>true,
                                ],
                            ...
                            'filterInputOptions'=>['placeholder'=>'Select Mode of Payment Description'],
                            'value'=>function($model){
                              ...
                              'delete' => function ($url, $model) {
                                  if(Yii::$app->user->can('_DELETE-MODE-OF-PAYMENT')){
                                      return ' ' . Html::a('<span class="fa fa-trash-o"></span>', ['delete', 'id'=>$model->id], [
                                          ...
                                          'data' => [
                                              'confirm' => "Are you sure to delete this mode of payment?",
                                              'method' => 'post',
                                          ], 
                  ...
                  if(Yii::$app->user->can('_DELETE-MULTIPLE-MODE-OF-PAYMENT')){
                    $gridcolumns[] = [
                      ...
                      'visible' => (Yii::$app->user->can('_DELETE-MULTIPLE-MODE-OF-PAYMENT')),
                      'width' => '50px;'
                    ]; 
                  }

                  $headercols = [
                      ['content' => 'Mode of Payment Information', 'options' => ['colspan' => 100, 'class' => 'text-center bg-primary']],
                  ];

                  $heading = 'List of Mode of Payment';
                  ...
                  $export = ExportMenu::widget([
                      ...
                      'filename' => 'modeofpayment',
                  ]);

                  if(Yii::$app->user->can('_DELETE-MULTIPLE-MODE-OF-PAYMENT')){
                    $after = '<div class="pull-right">
                    <button type="button" class="btn btn-flat btn-danger deleteSelectedModeOfPaymentbutton" data-placement="left" data-toggle="tooltip", title="Delete Selected">Delete Selected</button></div><div style="padding-top: 5px;">
                    <em>&nbsp;</em>
                    </div>
...
$('body').on('click', '.deleteSelectedModeOfPaymentbutton', function(){
    var deleteSelected = $('#modeofpayment').yiiGridView('getSelectedRows');
    if (deleteSelected == ''){
        ...
        swal({
          title: 'Are you sure?',
          text: 'The selected mode of payment will be deleted.',
          type: 'warning',
        ...
        function(){
            $.ajax({
                ...
                success : function() {
                    ...
                    swal('Success!', 'Selected Mode of Payment Successfully Deleted.', 'success');
                },
                error: function () {
                    swal('Error', 'Selected Mode of Payment Not Deleted.', 'error');
                }
            });
        });
    }
