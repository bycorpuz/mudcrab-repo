                ...
                <?php
                  $gridcolumns = [
                        ...
                        [
                            ...
                            'filterInputOptions'=>['placeholder'=>'Select Item Name'],
                        ...
                        [
                            ...
                            'filterType'=>GridView::FILTER_SELECT2,
                            'filter'=>ArrayHelper::map(Item::find()->asArray()->all(), 'description', 'description'), 
                            'filterWidgetOptions'=>[
                                'pluginOptions'=>[
                                    'allowClear'=>true,
                                ],
                            ...
                            'filterInputOptions'=>['placeholder'=>'Select Item Description'],
                            'value'=>function($model){
                  ...
                  if(Yii::$app->user->can('_DELETE-MULTIPLE-ITEM')){
                    $gridcolumns[] = [
                      ...
                      'visible' => (Yii::$app->user->can('_DELETE-MULTIPLE-ITEM')),
                      'width' => '50px;'
                    ]; 
                  }

                  $headercols = [
                      ['content' => 'Item Information', 'options' => ['colspan' => 100, 'class' => 'text-center bg-primary']],
                  ];

                  $heading = 'List of Item';
                  ...
                  if(Yii::$app->user->can('_DELETE-MULTIPLE-ITEM')){
                    ...
                    <button type="button" class="btn btn-flat btn-danger deleteSelectedItembutton" data-placement="left" data-toggle="tooltip", title="Delete Selected">Delete Selected</button></div><div style="padding-top: 5px;">
                    <em>&nbsp;</em>
                    </div>
...
$('body').on('click', '.deleteSelectedItembutton', function(){
    var deleteSelected = $('#item').yiiGridView('getSelectedRows');
    if (deleteSelected == ''){
        ...
        function(){
            $.ajax({
                ...
                error: function () {
                    swal('Error', 'Selected Item Not Deleted.', 'error');
                }
            });
        });
    }
